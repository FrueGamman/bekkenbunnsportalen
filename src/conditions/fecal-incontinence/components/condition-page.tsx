...
import { OverviewSection } from "../../shared"
...
export default function ConditionPage() {
  ...
  const [activeCondition, setActiveCondition] = useState("fecal-incontinence")
  ...
  return (
    <div className={`${styles.container} ${resolvedTheme === 'dark' ? styles.darkMode : ''}`}>
      ...
      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>Tilstander - Avføringslekkasje</h1>
      </div>
