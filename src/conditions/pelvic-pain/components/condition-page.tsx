...
export default function ConditionPage() {
  ...
  const [activeCondition, setActiveCondition] = useState("pelvic-pain")
  ...
  return (
    <div className={`${styles.container} ${resolvedTheme === 'dark' ? styles.darkMode : ''}`}>
      ...
      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>Tilstander - Langvarige underlivssmerter</h1>
      </div>
        ...
        <div className={styles.conditionNavContainer}>
          {ALL_CONDITIONS.map((condition) => (
            <button
              ...
              className={`${styles.conditionNavItem} ${activeCondition === condition.id ? styles.conditionNavItemActive : ""
                }`}
            >
      ...
      <ConditionIntroSection conditionId="pelvic-pain" />
