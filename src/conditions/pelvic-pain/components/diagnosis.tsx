        ...
        {sections.map((section) => {
          ...
          const content = (
            <div className={styles.normalFunctionContent}>
              ...
              {'examinationLinks' in section && (section as unknown as Record<string, any>).examinationLinks && (
                <ul className={styles.resourceList}>
                  {((section as unknown as Record<string, any>).examinationLinks as Array<{ text: string; linkText: string; url: string }>).map((exam: { text: string; linkText: string; url: string }, examIndex: number) => (
