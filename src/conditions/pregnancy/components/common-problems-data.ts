// Extract COMMON_PROBLEMS_DATA from existing common-problems.tsx for reuse
    ...
    sections: [
      ...
      },
      {
        ...
        keyPoints: [
          ...
          'Det is ikke normalt å ha lekkasje av avføring etter fødsel'
        ],
        video: 'https://player.vimeo.com/video/367327819?autoplay=1&muted=1&autopause=0&loop=0&title=1&portrait=1&byline=1',
        subsections: [
          {
            id: 'symptoms',
            title: 'Symptomer',
      ...
      },
      {
        ...
        intro: 'Det finnes to typer hemoroider, indre og ytre. Ved usikkerhet om hva blødning fra endetarm eller i avføring skyldes skal lege alltid kontaktes.',
        types: [
          'Indre hemorider kommer fra øvre del av endetarmen',
          'Ytre hemoroider kommer fra utsiden av endetarmsåpningen',
          'Ytre tromboserte hemoroider er en spesiell type som krever rask behandling'
        ],
        subsections: [
          {
            id: 'internal-external',
            title: 'Indre og ytre hemoroider',
            description: 'Indre hemorider kommer fra øvre del av endetarmen. Ytre hemoroider kommer fra utsiden av endetarmsåpningen.'
          },
          {
            id: 'symptoms',
            title: 'Symptomer',
          ...
          {
            id: 'thrombosed',
            title: 'Ytre tromboserte hemoroider',
            description: 'En spesiell type hemorider som krever rask behandling.'
          },
          {
          ...
          },
          {
            ...
            title: 'Råd for tromboserte hemoroider',
            items: [
          ...
          {
            id: 'thrombosed-help',
            title: 'Når og hvor søke hjelp for tromboserte hemoroider?',
      ...
      },
      {
        ...
        initialAdvice: ['Urinveisinfeksjon er mer vanlig blant gravide enn ikke-gravide kvinner.', 'Alle gravide undersøkes for forekomst av bakterier i urinen ved første svangerskapskontroll. ', 'Urinveisinfeksjon under graviditet skal alltid behandles med antibiotika.'],
        subsections: [
          {
            id: 'symptoms',
            title: 'Symptomer',
          ...
          },
          {
            id: 'seek-help',
            title: 'Når og hvor søke hjelp',
            items: ['Søk hjelp hos fastlege eller jordmor ved symptomer, husk å ta med urinprøve.', 'Urinveisinfeksjon hos gravide skal alltid behandles med antibiotika.']
          }
        ]
      },
      {
        ...
        initialAdvice: ['Tyngdefornemmelse og følelsen av prolaps enten via skjede eller endetarm, er vanlig de første månedene etter fødsel.', 'Tilstanden kan bedre seg etter ammeperioden som følge av hormonelle endringer.', 'Det finnes ulike typer prolaps som gir forskjellige symptomer.'],
        subsections: [
          {
            id: 'symptoms',
            title: 'Symptomer',
          ...
          },
          {
            id: 'seek-help',
            title: 'Når og hvor søke hjelp?',
            description: 'Dersom vedvarende plager bør man oppsøke fastege for undersøkelse og eventuell videre henvisning til: ',
            items: ['Gynekolog for vedvarende vannlatingsbesvær.', 'Gastrokirurg for hjelp til tømmingsproblemer for avføring.']
          }
        ]
      },
      {
      ...
      },
      {
        ...
        intro: 'Langvarige, vedvarende eller tilbakevendende smerter ved samleie er ikke normalt. Tilstanden har mange navn som vestibulitt, vulvodyni, dyspareuni, vaginisme, overaktiv bekkkenbunn eller langvarige underlivssmerter. Tilstandene krever individuell utredning og behandling.',
        keyPoints: [
          'Mer informasjon om sykdommer i ytre deler av underlivet på <a href="https://vulva.no/" target="_blank" rel="noopener noreferrer">Vulva.no</a>'
        ],
        subsections: [
          {
            id: 'pregnancy-intercourse',
            title: 'Samleie i svangerskapet',
            description: 'Samleie er ufarlig ved normalt svangerskap. Spor av blod under samleie er vanlig. Noen rådes til å avstå fra samleie på grunn av ulike forhold – følg råd gitt av lege eller jordmor.'
          },
          {
            id: 'pregnancy-help',
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Hemorrhoids',
        image: '/Hemorhoids.svg',
        intro: 'There are two types of hemorrhoids, internal and external. If uncertain about what bleeding from the rectum or in stool is caused by, a doctor should always be contacted.',
        types: [
          'Internal hemorrhoids come from the upper part of the rectum',
          'External hemorrhoids come from outside the anal opening',
          'External thrombosed hemorrhoids are a special type that requires prompt treatment'
        ],
        subsections: [
          {
            id: 'internal-external',
            title: 'Internal and External Hemorrhoids',
            description: 'Internal hemorrhoids come from the upper part of the rectum. External hemorrhoids come from outside the anal opening.'
          },
          {
            id: 'symptoms',
            title: 'Symptoms',
          ...
          {
            id: 'thrombosed',
            title: 'External Thrombosed Hemorrhoids',
            description: 'A special type of hemorrhoid that requires prompt treatment.'
          },
          {
            id: 'thrombosed-symptoms',
      ...
      },
      {
        ...
        image: '/Urinary Infenction.svg',
        initialAdvice: ['Urinary tract infection is more common among pregnant women than non-pregnant women.', 'All pregnant women are tested for the presence of bacteria in their urine at the first prenatal checkup.', 'Urinary tract infection during pregnancy should always be treated with antibiotics.'],
        subsections: [
          {
            id: 'symptoms',
            title: 'Symptoms',
          ...
          },
          {
            id: 'seek-help',
            title: 'When and Where to Seek Help',
            items: ['Seek help from a general practitioner or midwife with symptoms, remember to bring a urine sample.', 'Urinary tract infection in pregnant women should always be treated with antibiotics.']
          }
        ]
      },
      {
        ...
        image: '/Heaviness and Prolapse.svg',
        initialAdvice: ['Feeling of heaviness and sensation of prolapse either via vagina or rectum is common in the first months after childbirth.', 'The condition can improve after the breastfeeding period due to hormonal changes.', 'There are various types of prolapse that cause different symptoms.'],
        subsections: [
          {
            id: 'symptoms',
            title: 'Symptoms',
          ...
          },
          {
            id: 'seek-help',
            title: 'When and Where to Seek Help?',
            description: 'If persistent problems, you should see a general practitioner for examination and possible further referral to: ',
            items: ['Gynecologist for persistent urination problems.', 'Gastrointestinal surgeon for help with bowel evacuation problems.']
          }
        ]
      },
      {
      ...
      },
      {
        ...
        image: '/Sexualintercourse.svg',
        intro: 'Long-term, persistent, or recurring pain during intercourse is not normal. The condition has many names such as vestibulitis, vulvodynia, dyspareunia, vaginismus, overactive pelvic floor, or chronic pelvic pain. The conditions require individual investigation and treatment.',
        keyPoints: [
          'More information about diseases in the external genital area at <a href="https://vulva.no/" target="_blank" rel="noopener noreferrer">Vulva.no</a>'
        ],
        subsections: [
          {
            id: 'pregnancy-intercourse',
            title: 'Intercourse During Pregnancy',
            description: 'Intercourse is safe during normal pregnancy. Traces of blood during intercourse are common. Some are advised to abstain from intercourse due to various circumstances – follow advice given by doctor or midwife.'
          },
          {
            id: 'pregnancy-help',
