...
export const FemaleCircumcisionSection = ({ dataNo, dataEn }: FemaleCircumcisionSectionProps = {}) => {
  ...
  const data = dataNo != null && dataEn != null
    ? (language === "no" ? (dataNo as typeof femaleCircumcisionData.no) : (dataEn as typeof femaleCircumcisionData.en))
    : (language === "no" ? femaleCircumcisionData.no : femaleCircumcisionData.en)
