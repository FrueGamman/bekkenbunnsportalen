...
export default function ConditionPage() {
  ...
  const [activeCondition, setActiveCondition] = useState("urinary-retention")
  ...
  return (
    <div className={`${styles.container} ${resolvedTheme === 'dark' ? styles.darkMode : ''}`}>
      ...
      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>Tilstander - Tømmingsproblemer for urin</h1>
      </div>
      ...
      <ConditionIntroSection conditionId="urinary-retention" />
