    ...
    sections: [
      {
        ...
        content:
          "All pregnant women have the right to antenatal care. This is a free service that should provide advice and guidance so that the pregnant woman and the baby are as well as possible during pregnancy. This follow-up takes place with a midwife and/or GP.",
      },
      {
        title: "Six Week Check-up with GP",
        content:
          "Women are recommended to book an appointment with their GP for a check-up six weeks after birth. At this check-up, among other things, a gynecological examination is performed. If you have problems in the form of leakage, constipation, pain or other complaints, it is good to bring this up with the doctor already then.",
      },
      {
        title: "For Complaints",
        content:
          "Various complaints can occur after childbirth and are described in more detail in the chapters in the textbook. There are several different self-help tips that can lead to improvement. If you do not experience the desired effect, you should seek help. You can find a physiotherapist in your area through the physiotherapist directory.",
        link: {
