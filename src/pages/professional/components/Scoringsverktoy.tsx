  ...
  const scoringTools: { category: string; tools: ToolItem[] }[] = [
    {
      ...
      tools: [
        ...
        },
        {
          ...
          link: "https://nekib.helsekompetanse.no/wp-content/uploads/2023/03/VANNLATINGSDAGBOK.pdf",
        },
      ],
    },
    {
      ...
      tools: [
        {
          ...
          link: "https://nekib.helsekompetanse.no/wp-content/uploads/2023/03/St_Marks-score-red-2023.doc.pdf",
        },
        {
          id: "odss-wexner",
          name: "ODSS m/Wexner",
          description: "Obstructed Defecation Score with Wexner",
          link: "https://nekib.helsekompetanse.no/wp-content/uploads/2023/03/ODSS_WEXNER-red-2023.docx.pdf",
        },
        {
          id: "fiqls",
          name: "FIQLS",
          description: "Fecal Incontinence Quality of Life Scale",
          link: "https://nekib.helsekompetanse.no/wp-content/uploads/2023/03/FIQLS.pdf",
        },
        {
          id: "iciq-b",
          name: "ICIQ-B",
          description: "ICIQ-Bowel Questionnaire",
          link: "https://nekib.helsekompetanse.no/wp-content/uploads/2023/03/ICIQ_B-norsk-versjon.pdf",
        },
        {
          id: "bowel-diary",
          name: "Bowel diary",
          description: "Daily stool diary",
          link: "https://nekib.helsekompetanse.no/wp-content/uploads/2024/09/AvforingsDAGBOK-eksempel-fra-UNN-Narvik.doc",
        },
      ],
    },
    {
